/**
 * Created by cristian on 29/08/15.
 */
  /*
  * La librería aREST entra en conflicto con sails js, e intercepta todas las request
  * lo que ocasiona que el server no pueda enviar los resources (scripts, estilos, etc)
   * Para evitar esto se modifico el index.js ubicado en node_modules/aREST/
   * luego de realizar npm install, sobreescribir ese archivo con el siguiente contenido.
  *
  *
  * */
// Require modules
...
module.exports = function (app) {
  ...
  // Command
  app.get('/arduino/:command', function(req,res) {
    console.log(' Variable/function request sent to device: ' + 'Arduino');
    // Get device
    device = aREST.getDevice('Arduino');

    if (typeof(device) != 'undefined') {

      if (req.query.params && 'Arduino' === 'Arduino') {
  ...
  // Digital write
  app.get('/arduino/digital/:pin/:value', function(req,res){

    console.log('Digital write request sent to device: ' + 'Arduino');
  ...
  // Analog read
  app.get('/arduino/analog/:pin/', function(req,res){

    console.log('Analog read request sent to device: ' + 'Arduino');
  ...
  // Analog Write
  app.get('/arduino/analog/:pin/:value', function(req,res){

    console.log('Analog write request sent to device: ' + 'Arduino');
  ...
  // Digital read
  app.get('/arduino/digital/:pin/', function(req,res){

    console.log('Digital read request sent to device: ' + 'Arduino');
  ...
  // Mode
  app.get('/arduino/mode/:pin/:value', function(req,res){
  ...
  app.get('/arduino/camera/snapshot', function(req,res){

    console.log('Snapshot request sent to device: ' + 'Arduino');
